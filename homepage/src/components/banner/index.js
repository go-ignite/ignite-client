    ...
    <div className="main-banner">
      ...
      <MediaQuery minDeviceWidth={1224}>
        <div className="main-banner-wrap cloud1">
          ...
          <img className="main-banner-cloud1"
            sizes="(max-width: 2880px) 100vw, 2880px"
            srcSet={`${imgs.cloud1Bg720} 720w, ${imgs.cloud1Bg1440} 1440w, ${imgs.cloud1Bg2880} 2880w`}
        ...
        <div className="main-banner-wrap cloud2">
          ...
          <img
            sizes="(max-width: 2880px) 100vw, 2880px"
            srcSet={`${imgs.cloud2Bg720} 720w, ${imgs.cloud2Bg1440} 1440w, ${imgs.cloud2Bg2880} 2880w`}
        ...
        <div className="main-banner-wrap river">
          <img
            sizes="(max-width: 2880px) 100vw, 2880px"
            srcSet={`${imgs.riverBg720} 720w, ${imgs.riverBg1440} 1440w, ${imgs.riverBg2880} 2880w`}
            className="main-banner-river"
            alt=""
          />
        </div>
        <div className="main-banner-wrap plane">
          <img className="main-banner-plane" src={imgs.planeBg} alt="" />
        </div>
      </MediaQuery>
    </div>
  )
